    ...
    class SoftwareRendererImp: public SoftwareRenderer {
        public:
            ...
            inline void clear_target() {
                ...
                super_render_target.clear();
                sample_mark.clear();
            }

        private:
            // Primitive Drawing //
            size_t super_sample_rate;
            size_t super_target_w;
            size_t super_target_h;
            vector<char> super_render_target;
            vector<char> sample_mark;
            ...
            void super_sample_plot(float x, float y, Color color);
